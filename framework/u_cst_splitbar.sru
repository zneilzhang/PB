HA$PBExportHeader$u_cst_splitbar.sru
forward
global type u_cst_splitbar from statictext
end type
end forward
...
global u_cst_splitbar u_cst_splitbar
...
on u_cst_splitbar.create
end on

on u_cst_splitbar.destroy
end on
