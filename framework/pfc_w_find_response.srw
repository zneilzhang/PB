HA$PBExportHeader$pfc_w_find_response.srw
$PBExportComments$PFC Find window
forward
global type pfc_w_find_response from w_popup
end type
type st_findwhere from u_st within pfc_w_find_response
end type
type st_searchfor from u_st within pfc_w_find_response
end type
type ddlb_findwhere from u_ddlb within pfc_w_find_response
end type
type st_searchdirection from u_st within pfc_w_find_response
end type
type cbx_wholeword from u_cbx within pfc_w_find_response
end type
type cbx_matchcase from u_cbx within pfc_w_find_response
end type
type cb_findnext from u_cb within pfc_w_find_response
end type
type cb_cancel from u_cb within pfc_w_find_response
end type
type sle_findwhat from u_sle within pfc_w_find_response
end type
type ddlb_searchdirection from pfc_u_ddlb within pfc_w_find_response
end type
type cb_dlghelp from u_cb within pfc_w_find_response
end type
end forward
...
global pfc_w_find_response pfc_w_find_response
...
on pfc_w_find_response.destroy
call super::destroy
