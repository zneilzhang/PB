HA$PBExportHeader$u_powerfilter_predeffilters.sru
forward
...
public function integer of_initialize (datawindow a_dw, ref n_cst_powerfilter a_powerfilter_checkbox, integer ai_maxcol)
end prototypes
...
dw_1.Filter()
dw_1.sort()
//following 2 rows work for PB 11.5, not for 9.0
//dw_1.height = dw_1.rowcount() * 88 + 8
//this.height = dw_1.height + 4
