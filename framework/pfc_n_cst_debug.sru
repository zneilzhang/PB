...
$PBExportComments$%SPANISH% PFC Debug service
forward
...
type variables
Public:
constant integer	PFC_MAJOR = 8
constant integer	PFC_MINOR = 0
constant integer	PFC_FIXES = 0

constant string	PFC_NAME = "Biblioteca PowerBuilder Foundation Classes"
...
constant string	ics_pfc = "Biblioteca PowerBuilder Foundation Classes" // Obsoleted in 6.0
