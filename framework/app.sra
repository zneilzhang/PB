...
n_cst_principal_appmanager gnv_app 
...
string gs_descope, gs_num_cia, gs_clv_cia, gs_pass, gs_nombre_compania
long gi_nivel, gi_nivelcc, gi_numope
...
gnv_app = CREATE n_cst_principal_appmanager
