...
$PBExportComments$%SPANISH% PFC SQL Spy Service
forward
...
constant string	TITLE='Guardar el archivo SQLSpy'
...
If li_rc > 0 Then
	...
	If FileExists (ls_path_filename) Then
		...
		If of_MessageBox ('pfc_sqlspy_replacefile', TITLE, &
			'Reemplazar el archivo existente '+ls_path_filename, &
...
If Pos(Lower(ls_sqltype),Lower('Consultar')) = 0  Then
